# scikit-learn TPOT own container sample

This example shows how to package an algorithm for use with SageMaker. We have chosen a simple [TPOT][tpot] implementation to automate feature selection, model selection and parameter optimization in one place.
...
* __tpot__: The directory that contains the application to run in the container. See the next session for details about each of the files.
...
[tpot]: https://epistasislab.github.io/tpot/ "HOME - TPOT"
